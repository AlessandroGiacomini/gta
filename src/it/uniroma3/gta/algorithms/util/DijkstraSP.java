package it.uniroma3.gta.algorithms.util;
...
public class DijkstraSP {
    ...
    public String getStringPath(Iterable<DirectedEdge> pathTo, HashMap<Integer, String> intToNet) {
    	String result = "";
    	DirectedEdge last = null;
    	for (DirectedEdge e : pathTo) {
    		result = result + intToNet.get(e.from()) + " ";
    		last = e;
    	}
    	result = result + intToNet.get(last.to());
    	return result;
    }
